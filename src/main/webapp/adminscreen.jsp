...
<img alt="logo" src="images/cjclogo.jpeg" width="100px" height="50px">
<div class="pt-2">
<a href="#enroll">
...
<label class="form-label" for="birthdaydate">Student Age</label>
</div>
</div>

<div class="col-md-6 mb-2 pb-2">
<div class="form-outline">
<input type="tel" id="phoneNumber" class="form-control form-control-sm" name="studentCollegeName"/>
...
<div class="col-md-6 mb-2 pb-2">
<div class="form-outline">
<input type="text" id="emailAddress" class="form-control form-control-sm" name="FeesPaid"/>
<label class="form-label" for="emailAddress">Fees Paid</label>
</div>
</div>
<div class="col-md-6 mb-2">
<h6 class="mb-2 pb-1">Student Course :</h6>
<div class="form-check form-ckeck-inline">
<input class="form-check-input" type="radio" name="studentCourse" id="java" value="java" checked="checked"/>
<label class="form-check-label" for="java">Java</label>
</div>

<div class="form-check form-ckeck-inline">
<input class="form-check-input" type="radio" name="studentCourse" id="python" value="python" checked="checked"/>
<label class="form-check-label" for="python">Python</label>
</div>

<div class="form-check form-ckeck-inline">
<input class="form-check-input" type="radio" name="studentCourse" id="testing" value="testing" checked="checked"/>
...
<form name="fn">
<table class="table table-hover w-50 h-10" style="font-size:small">
<thead>
<tr>
<th>ID</th>
<th>Student Name</th>
